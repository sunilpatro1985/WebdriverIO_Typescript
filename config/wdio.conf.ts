...
export const config: Options.Testrunner = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            ...
            //args: ['--headless', '--disable-gpu', '--disable-dev-shm-usage'] //use this when headless is needed, for githubActions
    ...
    services: [['selenium-standalone', {drivers:{chrome:'112.0.5615.49'}}]],
